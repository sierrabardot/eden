export function LandingPageInfo() {
    return (
        <div className="vh-100 container-fluid bg-rhs d-flex flex-column justify-content-center align-items-center">
            ...
            Embark on a journey through our foraging map, where nature's wonders await for you.
            </p>
